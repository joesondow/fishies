...
public class LambdaRequestHandler implements RequestHandler<Object, Object> {
    ...
    public Object handleRequest(Object input, Context context) {
        ...
        // AWS Lambda only allows underscores in environment variables, not dots, so the
        // default ways twitter4j finds keys aren't possible. Instead, write your own code
        // that gets the configuration either from Lambda-friendly environment variables. If
        // those variables are missing, default to using the regular twitter4j algorithm of
        // getting keys from a default twitter4j.properties file at the project root, or on
        // the classpath, or in WEB-INF.
        ...
        // to target by retyping just the account name in the configuration.
        ...
        if (account != null) {
            ...
            String specificConsumerSecret = Environment
                    .get(account + "_twitter4j_oauth_consumerSecret");
            consumerSecret = (specificConsumerSecret != null) ? specificConsumerSecret
                    : consumerSecret;
            ...
            String specificAccTokSecret = Environment
                    .get(account + "_twitter4j_oauth_accessTokenSecret");
            accessTokenSecret = (specificAccTokSecret != null) ? specificAccTokSecret
                    : accessTokenSecret;
        }
        if (consumerKey != null) {
