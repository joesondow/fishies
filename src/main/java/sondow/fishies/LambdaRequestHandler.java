...
public class LambdaRequestHandler implements RequestHandler<Object, Object> {
	...
	public Object handleRequest(Object input, Context context) {
		...
		// AWS Lambda only allows underscores in environment variables, not dots, so the default ways twitter4j finds keys aren't
		// possible. Instead, write your own code that gets the configuration either from Lambda-friendly environment variables
